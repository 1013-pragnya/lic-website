...
export default function TataAigInsurance() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Tata AIG General Insurance Plans | Shamsuddin Ratnani";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', "Protect your vehicle, home, travel, and business with comprehensive Tata AIG insurance solutions.");
    }
  }, []);
  ...
  const handleEnquire = (title) => {
    handleCloseModal();
    navigate(`/?tab=insurance&plan=consult#contact`);
  };
  ...
  return (
    <div className="premium-partner-page tata-insurance-page">
      ...
      <section 
        ...
        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1557804506-6fd01a783382?auto=format&fit=crop&q=80&w=1920')` }}
      >

...
export default function CareHealthInsurance() {
  ...
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute('content', "Get complete health protection with Care Health Insurance. Cashless hospitalization, critical illness cover, and family health plans with lifetime renewability.");
    }
  }, []);
        ...
        <div className="partner-hero-container">
          <div className="partner-hero-content">
            <div className="partner-badge">
              <Shield size={14} /> Ultimate Family Protection
            </div>
            <h1 className="partner-hero-title">
              CARE HEALTH <span className="highlight-gold">Insurance</span>
            </h1>
            <p className="partner-hero-subtitle">
              Get complete health protection with cashless hospitalization, critical illness cover, and family health plans.
            </p>
